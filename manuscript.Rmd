...
Discussion
==========
This study showed that AFs do not perform well in predicting OFIs. 
...
designed for. This highlights their need for
consistent and evidence-based review to determine current usefulness
[@santana2014development]. However, such
review process might present with costs greater than the potential
benefit from AFs.

While AFs may help determining
OFIs, they could overshadow other factors contributing to that
analysis, resulting in over-reliance. AFs might disproportionally affect certain groups of
...
Higher ISS, longer times to CT, longer times to first intervention and higher levels of care were correlated with OFIs, corresponding with a previous study conducted at Karolinska University Hospital by Albaaj
et al. [@albaaj2023patient]. Greater severity and higher levels of care call for greater complexity, requiring more interventions, allowing for more mistakes. This could explain their correlation with OFI[@albaaj2023patient].
...
The AF "GCS<9 and not intubated" showed no significant ability to predict OFIs, similarly shown by Willis et al. [@willis2008interpreting] in 2008. An
explanation for this could be that an abnormal GCS as a result from
intoxication versus head injury for example are not comparable, suggesting that the AF might be more reflective of clinical
decision rather than quality of care [@willis2008interpreting]. However, according to Sanddal et al. [@sanddal2011analysis] airway management was
associated with OFI, suggesting that an alternative AF related
to airway management might perform differently.
...
[@ghorbani2018analysis] identified delay in treatment and delay to CT as common errors in trauma care. A more recent
...
CT within 10 minutes of arrival at the ED. Notably,
OFI in this study was not soley a reflection of mortality but also morbidity. Rather, it
highlights the difference between hospitals, which AFs are in use, and
how they are assessed.

AFs that present with a high risk of inevitable death: "Dead
at 30 days" and "CPR and thoracotomy" showed no correlation with OFI. This could be explained by inevitable
...
OFI, while dichotomously defined, includes a
diverse set of outcomes. This convolutes the process of creating AFs
that perform well in predicting OFIs. AFs would favour the
...
the same patient case had multiple AFs introduce uncertainty
regarding which specific AF truthfully predicted the OFI.
...
Our findings suggest that AFs perform poorly in predicting an OFI. The AFs
with performance exceeding coincidence (AUC = 0.5) might be a beneficial
addition to an already existing QI programme or
...
other hospitals facing unique challenges
